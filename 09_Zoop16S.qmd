...
selectInput('DephtRank','Depht as Rank N/Y',selected = 2,DephtRank)
selectInput('Standardize',  'Depht in the log scale',selected = 2,LogDepth)
selectInput('LogDepth',  'Normalizing Latitude and Depht',selected = 2,Standardize)
selectInput('ABS_Latitude','Abs of the Latitude N/Y',selected = 2,ABS_Latitude)
```
:::
...
clusters_mixdist <- reactive({
  MixDist_Clust(metadat_aux = metadat,
                ...
                logDepth = ifelse(input$LogDepth =='Y',T,F),
